...
def analyze_email_task(
    ...
    try:
        result = analysis_service.analyze_raw_email(
            raw,
        ...
        stored_result = privacy_service.mask_report(result)
        database.save_case({
            "analysis_id": analysis_id,
            "status": "COMPLETED",
            ...
            "forensic_report": stored_result,
            "indicators_of_compromise": stored_result["indicators_of_compromise"],
        })
